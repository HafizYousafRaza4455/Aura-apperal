...
import { Navbar, NavCategory } from './components/layout/Navbar';
import { MobileDrawer } from './components/layout/MobileDrawer';
import { Hero } from './components/home/Hero';
import { CollectionsShowcase } from './components/home/CollectionsShowcase';
import { BrandStory } from './components/home/BrandStory';
import { Footer } from './components/layout/Footer';
import { Category, SortOption, Product, ProductColor } from './types/product';
import { filterAndSortProducts } from './data/products';
import { CategoryFilter } from './components/catalog/CategoryFilter';
import { ProductGrid } from './components/catalog/ProductGrid';
import { ProductModal, AddToCartPayload } from './components/modal/ProductModal';
import { CartProvider, useCart } from './context/CartContext';
import { CartDrawer } from './components/cart/CartDrawer';
import { AdminProvider, useAdmin } from './context/AdminContext';

/** Inner app component — inside CartProvider and AdminProvider */
function AppInner() {
  ...
  // Reactively compute filtered and sorted products from dynamic Admin catalog
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#FBF9F9]">
      ...
      <main className="flex-1">
        ...
        {/* 3. Three Movements Curated Category Cards */}
        <CollectionsShowcase onSelectCategory={handleSelectCategory} />

        {/* 4. Product Catalog Section (Milestone 2) */}
        <div id="catalog" className="scroll-mt-20">
          {/* Editorial Section Header with Accessible Category Readout */}
          ...
          {/* Interactive Category Filter Tabs & Sort Dropdown */}
          <CategoryFilter
            activeCategory={activeCategory}
            onSelectCategory={handleSelectCategory}
            currentSort={sortBy}
        ...
        {/* 5. Asymmetric Brand Story Manifesto */}
        <BrandStory />
      </main>

      {/* 6. Luxury Footer & Newsletter */}
      <Footer
        onSelectCategory={handleSelectCategory}
        currentCurrency={currency}
        onCurrencyChange={setCurrency}
      ...
      {/* 7. Product Detail Quick View Modal (Milestone 3) */}
      <ProductModal
      ...
      {/* 8. Slide-out Cart Drawer (Milestone 4) */}
